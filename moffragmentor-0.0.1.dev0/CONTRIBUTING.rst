...
----------------------------------
1. Check that you have the latest version of :code:`moffragmentor`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/kjappelbaum/moffragmentor/issues
...
.. code-block:: sh
    ...
    $ git clone https://github.com/<YourUsername>/moffragmentor
...
If you spend a while working on your changes, further commits may be made to the main :code:`moffragmentor`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/kjappelbaum/moffragmentor
