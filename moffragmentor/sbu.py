...
def write_tobacco_cif(m: Molecule, connection_indices):
    ...
    header_lines = ['data_', '_audit_creation_date              ' + datetime.datetime.today().strftime('%Y-%m-%d'),"_audit_creation_method            'moffragmentor'", "_symmetry_space_group_name_H-M    'P1'", '_symmetry_Int_Tables_number       1','_symmetry_cell_setting            triclinic', 'loop_' '_symmetry_equiv_pos_as_xyz', '  x,y,z']
    ...
    loop_header = ['loop_', '_atom_site_label', '_atom_site_type_symbol', '_atom_site_fract_x', '_atom_site_fract_y', '_atom_site_fract_z' 
    '_atom_site_charge' ]
